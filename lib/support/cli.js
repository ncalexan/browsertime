...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('block', {
      describe:
        'Domain to block. Add multiple instances to add multiple domains that will be blocked. If you use Chrome you can also use --blockDomainsExcept (that is more performant)'
    })
    .option('percentiles', {
      type: 'array',
